...
async function evidenceFixture() {
  ...
  const excerpt = await createEvidenceExcerpt({ id: "excerpt-a", workId: verifiedWork.id, paraphrase: "Synthetic supporting evidence.", locator: "p. 12", claimId: "claim-a", supportDirection: "supporting", verificationStatus: "human_verified", reviewer: "Researcher", reviewedAt: "2026-08-19T00:00:00.000Z" }, project.id);
