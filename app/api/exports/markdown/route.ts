...
export async function GET(request: Request) {
  ...
  const body = exportProjectDocumentMarkdown(project, exportDocument, formal && versionId ? formalExportSnapshot(projectId, documentId, versionId).workspace : await readWorkspace(projectId), audit);
